...
Notes:
    ...
    cd ~/code/git_sync/docs
    sphinx-apidoc -f -o ~/code/git_sync/docs/source ~/code/git_sync/git_sync --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/git_sync/advanced/
        ...
        Click import project: (for github you can select, but gitlab you need to import manually)
            Set the Repository NAME: git_sync
            Set the Repository URL: https://github.com/Erotemic/git_sync

        For gitlab you also need to setup an integrations and add gitlab
        incoming webhook

            https://readthedocs.org/dashboard/git_sync/integrations/create/

        Then go to

            https://github.com/Erotemic/git_sync/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/git_sync/versions/
"""
#
...
# html_logo = '.static/git_sync.svg'
# html_favicon = '.static/git_sync.ico'
...
latex_documents = [
    (master_doc, 'git_sync.tex', 'git_sync Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'git_sync', 'git_sync Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'git_sync', 'git_sync Documentation',
     author, 'git_sync', 'One line description of project.',
     'Miscellaneous'),
]
